...
class Tracker:
    ...
    def run_tracker(self, weights_collected):
        ...
        if len(weights_collected) in []:
            ...
            for num in [21, 25]: #[17.5, 18.5]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in []:
            for num in [17, 18]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in [2]:
            for num in [19, 24]: #[16.5, 17.5]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in []:
            for num in [16, 17]:
                self.run_tracker(weights_collected + (num,))
            ...
            for num in [3, 7]: #[2.7, 3]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in []:
            for num in [2.5, 2.8]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in [10]:
            for num in [2, 6]: #[2.2, 2.5]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in []:
            for num in [2, 2.5]:
                self.run_tracker(weights_collected + (num,))
            ...
            for num in [1, 4]: #[1, 1.3]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in [12]:
            for num in [1, 4]: #[0.7, 1]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in []:
            for num in [0.5, 0.8]:
                self.run_tracker(weights_collected + (num,))
            ...
            for num in [0.5, 4.5]: #[0, 0.3]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in [5, 13, 14]:
            for num in [0, 3]: #[0, 0.3]:
                self.run_tracker(weights_collected + (num,))
        elif len(weights_collected) in []:
            for num in [0]:
                self.run_tracker(weights_collected + (num,))
