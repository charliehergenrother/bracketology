...
BRACKET_RESULTS = {
        ...
        #"America East": [],
        #"American": [],
        "ASUN": {0: ["Bellarmine", "FGCU", "Stetson", "West-Georgia"]},
        #"Atlantic 10": [],
        #"Big 12": [],
        #"Big East": [],
        #"Big Sky": [],
        "Big South": {0: ["Gardner-Webb"]},
        #"Big Ten": [],
        #"Big West": [],
        #"Coastal Athletic": [],
        #"Conference USA": [],
        ...
        #"Ivy League": [],
        "MAAC": {0: ["Sacred-Heart", "Fairfield"]},
        #"MEAC": [],
        #"Mid-American": [],
        "Missouri Valley": {0: ["Drake", "Valparaiso", "Northern-Iowa"]},
        #"Mountain West": [],
        "NEC": {0: ["Wagner", "Long-Island", "Mercyhurst", "Stonehill"]},
        "Ohio Valley": {0: ["Eastern-Illinois", "Lindenwood"], 1: ["Tennessee-Martin", "Southeast-Missouri"]},
        "Patriot League": {0: ["Holy-Cross", "Bucknell"], 1: ["Boston-University", "Colgate", "Lehigh", "Navy"]},
        #"SEC": [],
        #"Southern": [],
        #"Southland": [],
        "Sun Belt": {0: ["Louisiana", "Old-Dominion"], 1: ["James-Madison", "Georgia-Southern"], 2: ["Southern-Miss", "Georgia-Southern"]},
        #"SWAC": [],
        "The Summit League": {0: ["Oral-Roberts"], 1: ["North-Dakota-State", "Saint-Thomas"]},
        "West Coast": {0: ["Portland", "San-Diego"]}
        #"Western Athletic": []
}

BRACKET_RESULTS_W = {
        "ACC": {0: ["Miami-FL", "California", "Georgia-Tech"], 1: ["Notre-Dame", "Clemson", "Syracuse", "Virginia-Tech"]},
        "America East": {0: ["Maine", "Vermont", "Binghamton", "UMBC"]},
        #"American": [],
        "ASUN": {0: ["Austin-Peay", "FGCU", "West-Georgia", "North-Alabama"], 1: ["Austin-Peay", "Stetson", "Jacksonville", "Central-Arkansas"]},
        "Atlantic 10": {0: ["Duquesne", "Saint-Louis"], 1: ["Loyola-Chicago", "Saint-Josephs", "Dayton", "La-Salle"]},
        "Big 12": {0: ["Kansas-State", "BYU", "Arizona-State", "Kansas"], 1: ["Kansas-State", "BYU", "Arizona-State", "Colorado"]},
        #"Big East": [],
        #"Big Sky": [],
        "Big South": {0: ["South-Carolina-Upstate"], 1: ["High-Point", "Winthrop", "Radford", "Longwood"]},
        "Big Ten": {0: ["Indiana", "Illinois", "Oregon"], 1: ["Washington", "Ohio-State", "Illinois", "Oregon"]},
        #"Big West": [],
        #"Coastal Athletic": [],
        #"Conference USA": [],
        "Horizon League": {0: ["Detroit"], 1: ["Cleveland-State", "Youngstown-State", "Purdue-Fort-Wayne", "IU-Indianapolis", "Green-Bay"]},
        #"Ivy League": [],
        "MAAC": {0: ["Manhattan", "Sacred-Heart"]},
        #"MEAC": [],
        #"Mid-American": [],
        #"Missouri Valley": [],
        #"Mountain West": [],
        #"NEC": [],
        "Ohio Valley": {0: ["Southeast-Missouri", "SIUE"], 1: ["Southeast-Missouri", "Southern-Indiana"]},
        #"Patriot League": [],
        "SEC": {0: ["Kentucky", "Florida", "Auburn", "Alabama"], 1: ["Kentucky", "Oklahoma", "Ole-Miss", "Alabama"]},
        "Southern": {0: ["Chattanooga", "East-Tennessee-State", "Samford", "Furman"]},
        #"Southland": [],
        "Sun Belt": {0: ["South-Alabama", "Louisiana"], 1: ["South-Alabama", "ULM"], 2: ["South-Alabama", "ULM"]},
        #"SWAC": [],
        "The Summit League": {0: ["Omaha"], 1: ["South-Dakota-State", "North-Dakota-State"]},
        "West Coast": {0: ["Washington-State", "San-Diego"]},
        #"Western Athletic": []
}
