...
class Builder:
    ...
    def output_bracket(self):
        ...
        f.write('        <a href="charliehergenrother.github.io/bracketology/men.html">Men\'s Bracket</a>\n')
        f.write('      </li>\n')
        f.write('      <li class="link_element">\n')
        f.write('        <a href="charliehergenrother.github.io/bracketology/women.html">Women\'s Bracket</a>\n')
        f.write('      </li>\n')
        f.write('      <li class="link_element">\n')
        f.write('        <a href="charliehergenrother.github.io/bracketology/menfuture.html">Men\'s Future Bracket</a>\n')
        f.write('      </li>\n')
        f.write('      <li class="link_element">\n')
        f.write('        <a href="charliehergenrother.github.io/bracketology/womenfuture.html">Women\'s Future Bracket</a>\n')
        f.write('      </li>\n')
        f.write('    </ul>\n')
        f.write('  </nav>\n')
        f.write('</div>\n')
