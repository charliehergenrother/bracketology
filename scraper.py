...
BRACKET_RESULTS_W = {
        ...
        "America East": {0: ["Maine", "Vermont", "Binghamton", "UMBC"]},
        #"American": [],
        "ASUN": {0: ["Austin-Peay", "FGCU", "West-Georgia", "North-Alabama"], 1: ["Austin-Peay", "Stetson", "Jacksonville", "Central-Arkansas"], 2: ["Austin-Peay", "Jacksonville"]},
        ...
        "Big East": {0: ["Georgetown", "Providence", "Saint-Johns"], 1: ["Connecticut", "Creighton", "Villanova", "Seton-Hall"], 2: ["Connecticut", "Villanova"]},
        "Big Sky": {0: ["Weber-State", "Montana"], 1: ["Idaho", "Montana-State"]},
        ...
        #"Coastal Athletic": [],
        #"Conference USA": [],
        "Horizon League": {0: ["Detroit"], 1: ["Cleveland-State", "Youngstown-State", "Purdue-Fort-Wayne", "IU-Indianapolis", "Green-Bay"], 2: ["Purdue-Fort-Wayne"]},
        #"Ivy League": [],
        "MAAC": {0: ["Manhattan", "Sacred-Heart"], 1: ["Quinnipiac", "Fairfield", "Iona", "Merrimack"], 2: ["Quinnipiac", "Fairfield"]},
        #"MEAC": [],
        #"Mid-American": [],
        #"Missouri Valley": [],
        ...
        #"Southland": [],
        "Sun Belt": {0: ["South-Alabama", "Louisiana"], 1: ["South-Alabama", "ULM"], 2: ["South-Alabama", "ULM"], 3: ["South-Alabama", "ULM"], 4: ["James-Madison", "Arkansas-State"], 5: ["James-Madison", "Troy"]},
        #"SWAC": [],
        ...
        "West Coast": {0: ["Washington-State", "San-Diego"], 1: ["Washington-State", "San-Francisco"], 2: ["Portland", "San-Francisco"], 3: ["Oregon-State", "Santa-Clara"]},
        #"Western Athletic": []
}
