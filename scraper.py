...
BRACKET_RESULTS = {
        "ACC": {0: ["Pittsburgh", "SMU", "Wake-Forest"], 1: ["North-Carolina-State", "Louisville", "Florida-State", "Clemson"]},
        "America East": {0: ["UMBC", "UMass-Lowell", "Vermont", "NJIT"], 1: ["UMBC", "Vermont"]},
        "American": {0: ["Tulane", "FAU"]},
        ...
        "Atlantic 10": {0: ["Saint-Bonaventure", "Loyola-Chicago"]},
        "Big 12": {0: ["Arizona-State", "Cincinnati", "BYU", "Oklahoma-State"], 1: ["Iowa-State", "UCF", "BYU", "TCU"]},
        "Big East": {0: ["Providence", "Xavier", "Georgetown"]},
        ...
        "Big Ten": {0: ["Maryland", "Northwestern"], 1: ["Iowa", "Washington", "Northwestern", "Rutgers"]},
        "Big West": {0: ["UC-San-Diego", "UC-Davis"]},
        ...
        "Conference USA": {0: ["Missouri-State", "New-Mexico-State"], 1: ["Missouri-State", "Sam-Houston-State"]},
        ...
        "SEC": {0: ["Kentucky", "Auburn", "Ole-Miss", "Oklahoma"]},
        ...
        "SWAC": {0: ["Alcorn-State", "Grambling-State"], 1: ["Prairie-View-AM", "Jackson-State"], 2: ["Prairie-View-AM", "Florida-AM"]},
        ...
        "Western Athletic": {0: ["Abilene-Christian"]}
}
...
BRACKET_RESULTS_W = {
        ...
        "American": {0: ["FAU", "Temple"], 1: ["North-Texas", "UTSA"]},
        ...
        "Big West": {0: ["Cal-State-Fullerton", "UC-Riverside"]},
        "Coastal Athletic": {0: ["UNCW"]},
        "Conference USA": {0: ["Delaware", "Jacksonville-State"], 1: ["Louisiana-Tech", "FIU"]},
        ...
        "MEAC": {0: ["Howard", "Maryland-Eastern-Shore"]},
        ...
        "NEC": {0: ["Mercyhurst", "Fairleigh-Dickinson", "Long-Island", "Le-Moyne"]},
        ...
        "Patriot League": {0: ["Boston-University", "Colgate"], 1: ["Army", "Lehigh", "Holy-Cross", "Navy"]},
        ...
        "Southland": {0: ["Northwestern-State", "Nicholls"], 1: ["UTRGV", "Stephen-F-Austin"], 2: ["McNeese", "Stephen-F-Austin"]},
        ...
        "SWAC": {0: ["Bethune-Cookman", "Mississippi-Valley-State"], 1: ["Florida-AM", "Arkansas-Pine-Bluff"], 2: ["Alabama-AM", "Arkansas-Pine-Bluff"]},
