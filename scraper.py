...
BRACKET_RESULTS = {
        #"ACC": [],
        "America East": {0: ["UMBC", "UMass-Lowell", "Vermont", "NJIT"]},
        #"American": [],
        ...
        #"Big Ten": [],
        #"Big West": [],
        "Coastal Athletic": {0: ["Northeastern"], 1: ["Campbell", "Drexel", "Towson", "William-Mary"], 2: ["Campbell", "Monmouth", "Towson", "Hofstra"], 3: ["Monmouth", "Hofstra"]},
        #"Conference USA": [],
        "Horizon League": {0: ["Cleveland-State"], 1: ["Green-Bay", "Detroit", "Northern-Kentucky", "Robert-Morris", "Wright-State"], 2: ["Northern-Kentucky"], 3: ["Wright-State", "Detroit"]},
        #"Ivy League": [],
        ...
        #"Mountain West": [],
        "NEC": {0: ["Wagner", "Long-Island", "Mercyhurst", "Stonehill"], 1: ["Long-Island", "Mercyhurst"]},
        ...
        "Southland": {0: ["New-Orleans", "Nicholls"], 1: ["Texas-AM-Corpus-Christi", "UTRGV"]},
        ...
        "SWAC": {0: ["Alcorn-State", "Grambling-State"]},
        ...
        "West Coast": {0: ["Portland", "San-Diego"], 1: ["Portland", "Seattle-University"], 2: ["San-Francisco", "Pacific"], 3: ["Oregon-State", "Santa-Clara"], 4: ["Gonzaga", "Santa-Clara"]}
        #"Western Athletic": []
}
...
BRACKET_RESULTS_W = {
        ...
        "Big Sky": {0: ["Weber-State", "Montana"], 1: ["Idaho", "Montana-State", "Sacramento-State", "Eastern-Washington"]},
        ...
        #"Coastal Athletic": [],
        #"Conference USA": [],
        "Horizon League": {0: ["Detroit"], 1: ["Cleveland-State", "Youngstown-State", "Purdue-Fort-Wayne", "IU-Indianapolis", "Green-Bay"], 2: ["Purdue-Fort-Wayne"], 3: ["Green-Bay", "Youngstown-State"]},
        #"Ivy League": [],
        "MAAC": {0: ["Manhattan", "Sacred-Heart"], 1: ["Quinnipiac", "Fairfield", "Iona", "Merrimack"], 2: ["Quinnipiac", "Fairfield"], 3: ["Fairfield"]},
        #"MEAC": [],
        #"Mid-American": [],
        #"Missouri Valley": [],
        "Mountain West": {0: ["Air-Force", "Boise-State", "Fresno-State", "Grand-Canyon"], 1: ["Air-Force", "Boise-State", "UNLV", "Colorado-State"], 2: ["Air-Force", "Colorado-State"]},
        ...
        "Southland": {0: ["Northwestern-State", "Nicholls"]},
        ...
        "SWAC": {0: ["Bethune-Cookman", "Mississippi-Valley-State"]},
        ...
        "West Coast": {0: ["Washington-State", "San-Diego"], 1: ["Washington-State", "San-Francisco"], 2: ["Portland", "San-Francisco"], 3: ["Oregon-State", "Santa-Clara"], 4: ["Oregon-State", "Gonzaga"]},
        #"Western Athletic": []
}
