...
BRACKET_RESULTS = {
        ...
        #"American": [],
        "ASUN": {0: ["Bellarmine", "FGCU", "Stetson", "West-Georgia"], 1: ["Central-Arkansas", "FGCU", "Austin-Peay", "Queens"], 2: ["Central-Arkansas", "Queens"]},
        #"Atlantic 10": [],
        #"Big 12": [],
        #"Big East": [],
        "Big Sky": {0: ["Idaho-State", "Idaho"]},
        "Big South": {0: ["Gardner-Webb"], 1: ["High-Point", "Winthrop", "UNC-Asheville", "Presbyterian-College"], 2: ["High-Point", "Winthrop"]},
        #"Big Ten": [],
        #"Big West": [],
        "Coastal Athletic": {0: ["Northeastern"], 1: ["Campbell", "Drexel", "Towson", "William-Mary"]},
        #"Conference USA": [],
        "Horizon League": {0: ["Cleveland-State"], 1: ["Green-Bay", "Detroit", "Northern-Kentucky", "Robert-Morris", "Wright-State"]},
        #"Ivy League": [],
        "MAAC": {0: ["Sacred-Heart", "Fairfield"], 1: ["Merrimack", "Fairfield", "Marist", "Siena"]},
        #"MEAC": [],
        #"Mid-American": [],
        "Missouri Valley": {0: ["Drake", "Valparaiso", "Northern-Iowa"], 1: ["Drake", "UIC", "Bradley", "Northern-Iowa"], 2: ["UIC", "Northern-Iowa"]},
        #"Mountain West": [],
        ...
        "Patriot League": {0: ["Holy-Cross", "Bucknell"], 1: ["Boston-University", "Colgate", "Lehigh", "Navy"]},
        #"SEC": [],
        "Southern": {0: ["UNCG", "The-Citadel"], 1: ["East-Tennessee-State", "UNCG", "Furman", "Western-Carolina"]},
        #"Southland": [],
...
BRACKET_RESULTS_W = {
        "ACC": {0: ["Miami-FL", "California", "Georgia-Tech"], 1: ["Notre-Dame", "Clemson", "Syracuse", "Virginia-Tech"], 2: ["Notre-Dame", "Duke", "Louisville", "North-Carolina"], 3: ["Duke", "Louisville"]},
        ...
        "Atlantic 10": {0: ["Duquesne", "Saint-Louis"], 1: ["Loyola-Chicago", "Saint-Josephs", "Dayton", "La-Salle"], 2: ["Rhode-Island", "Davidson", "George-Mason", "Richmond"], 3: ["Rhode-Island", "George-Mason"]},
        "Big 12": {0: ["Kansas-State", "BYU", "Arizona-State", "Kansas"], 1: ["Kansas-State", "BYU", "Arizona-State", "Colorado"], 2: ["Kansas-State", "TCU", "West-Virginia", "Colorado"], 3: ["TCU", "West-Virginia"]},
        "Big East": {0: ["Georgetown", "Providence", "Saint-Johns"], 1: ["Connecticut", "Creighton", "Villanova", "Seton-Hall"]},
        "Big Sky": {0: ["Weber-State", "Montana"]},
        "Big South": {0: ["South-Carolina-Upstate"], 1: ["High-Point", "Winthrop", "Radford", "Longwood"], 2: ["High-Point", "Radford"]},
        "Big Ten": {0: ["Indiana", "Illinois", "Oregon"], 1: ["Washington", "Ohio-State", "Illinois", "Oregon"], 2: ["UCLA", "Ohio-State", "Iowa", "Michigan"], 3: ["UCLA", "Iowa"]},
        #"Big West": [],
        #"Coastal Athletic": [],
        #"Conference USA": [],
        "Horizon League": {0: ["Detroit"], 1: ["Cleveland-State", "Youngstown-State", "Purdue-Fort-Wayne", "IU-Indianapolis", "Green-Bay"]},
        #"Ivy League": [],
        "MAAC": {0: ["Manhattan", "Sacred-Heart"], 1: ["Quinnipiac", "Fairfield", "Iona", "Merrimack"]},
        #"MEAC": [],
        #"Mid-American": [],
        #"Missouri Valley": [],
        ...
        "SEC": {0: ["Kentucky", "Florida", "Auburn", "Alabama"], 1: ["Kentucky", "Oklahoma", "Ole-Miss", "Alabama"], 2: ["South-Carolina", "LSU", "Ole-Miss", "Texas"], 3: ["South-Carolina", "Texas"]},
        "Southern": {0: ["Chattanooga", "East-Tennessee-State", "Samford", "Furman"], 1: ["Chattanooga", "Samford"]},
        #"Southland": [],
        "Sun Belt": {0: ["South-Alabama", "Louisiana"], 1: ["South-Alabama", "ULM"], 2: ["South-Alabama", "ULM"], 3: ["South-Alabama", "ULM"], 4: ["James-Madison", "Arkansas-State"]},
        #"SWAC": [],
        "The Summit League": {0: ["Omaha"], 1: ["South-Dakota-State", "North-Dakota-State", "Saint-Thomas", "South-Dakota"], 2: ["North-Dakota-State", "South-Dakota-State"]},
        "West Coast": {0: ["Washington-State", "San-Diego"], 1: ["Washington-State", "San-Francisco"], 2: ["Portland", "San-Francisco"]},
        #"Western Athletic": []
}
