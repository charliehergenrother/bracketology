...
BRACKET_RESULTS = {
        ...
        "Ohio Valley": {0: ["Eastern-Illinois", "Lindenwood"]},
        "Patriot League": {0: ["Holy-Cross", "Bucknell"]},
        #"SEC": [],
        #"Southern": [],
        #"Southland": [],
        "Sun Belt": {0: ["Louisiana", "Old-Dominion"], 1: ["James-Madison", "Georgia-Southern"]},
        #"SWAC": [],
        "The Summit League": {0: ["Oral-Roberts"]},
        #"West Coast": []
        #"Western Athletic": []
}

BRACKET_RESULTS_W = {
        "ACC": {0: ["Miami-FL", "California", "Georgia-Tech"]},
        #"America East": [],
        #"American": [],
        "ASUN": {0: ["Austin-Peay", "FGCU", "West-Georgia", "North-Alabama"]},
        "Atlantic 10": {0: ["Duquesne", "Saint-Louis"]},
        "Big 12": {0: ["Kansas-State", "BYU", "Arizona-State", "Kansas"]},
        #"Big East": [],
        #"Big Sky": [],
        "Big South": {0: ["South-Carolina-Upstate"]},
        "Big Ten": {0: ["Indiana", "Illinois", "Oregon"]},
        #"Big West": [],
        #"Coastal Athletic": [],
        #"Conference USA": [],
        ...
        #"Mountain West": [],
        #"NEC": [],
        "Ohio Valley": {0: ["Southeast-Missouri", "SIUE"]},
        #"Patriot League": [],
        "SEC": {0: ["Kentucky", "Florida", "Auburn", "Alabama"]},
        #"Southern": [],
        #"Southland": [],
        "Sun Belt": {0: ["South-Alabama", "Louisiana"], 1: ["South-Alabama", "ULM"]},
        #"SWAC": [],
        "The Summit League": {0: ["Omaha"]},
        #"West Coast": []
        #"Western Athletic": []
}
