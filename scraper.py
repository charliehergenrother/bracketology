...
BRACKET_RESULTS = {
        "ACC": {0: ["Pittsburgh", "SMU", "Wake-Forest"], 1: ["North-Carolina-State", "Louisville", "Florida-State", "Clemson"], 2: ["Virginia", "Miami-FL", "Duke", "Clemson"]},
        "America East": {0: ["UMBC", "UMass-Lowell", "Vermont", "NJIT"], 1: ["UMBC", "Vermont"]},
        "American": {0: ["Tulane", "FAU"], 1: ["Charlotte", "North-Texas"]},
        ...
        "Atlantic 10": {0: ["Saint-Bonaventure", "Loyola-Chicago"], 1: ["George-Washington", "Saint-Bonaventure", "Duquesne", "Davidson"]},
        "Big 12": {0: ["Arizona-State", "Cincinnati", "BYU", "Oklahoma-State"], 1: ["Iowa-State", "UCF", "BYU", "TCU"], 2: ["Iowa-State", "Arizona", "Houston", "Kansas"]},
        "Big East": {0: ["Providence", "Xavier", "Georgetown"], 1: ["Saint-Johns", "Seton-Hall", "Connecticut", "Georgetown"]},
        ...
        "Big Ten": {0: ["Maryland", "Northwestern"], 1: ["Iowa", "Washington", "Northwestern", "Rutgers"], 2: ["Ohio-State", "Wisconsin", "Purdue", "UCLA"]},
        "Big West": {0: ["UC-San-Diego", "UC-Davis"], 1: ["Cal-State-Northridge", "Cal-State-Fullerton"]},
        ...
        "Conference USA": {0: ["Missouri-State", "New-Mexico-State"], 1: ["Missouri-State", "Sam-Houston-State", "Louisiana-Tech", "Kennesaw-State"]},
        ...
        "MEAC": {0: ["Delaware-State", "South-Carolina-State", "North-Carolina-Central"]},
        "Mid-American": {0: ["UMass", "Toledo", "Akron", "Kent-State"]},
        "Missouri Valley": {0: ["Drake", "Valparaiso", "Northern-Iowa"], 1: ["Drake", "UIC", "Bradley", "Northern-Iowa"], 2: ["UIC", "Northern-Iowa"], 3: ["Northern-Iowa"]},
        "Mountain West": {0: ["UNLV", "Nevada", "Colorado-State", "San-Jose-State"], 1: ["Utah-State", "Nevada", "San-Diego-State", "New-Mexico"]},
        ...
        "SEC": {0: ["Kentucky", "Auburn", "Ole-Miss", "Oklahoma"], 1: ["Kentucky", "Tennessee", "Ole-Miss", "Oklahoma"]},
        ...
        "SWAC": {0: ["Alcorn-State", "Grambling-State"], 1: ["Prairie-View-AM", "Jackson-State"], 2: ["Prairie-View-AM", "Florida-AM", "Alabama-AM", "Southern"]},
        ...
        "Western Athletic": {0: ["Abilene-Christian"], 1: ["UTA", "Utah-Tech"]}
}
...
BRACKET_RESULTS_W = {
        ...
        "America East": {0: ["Maine", "Vermont", "Binghamton", "UMBC"], 1: ["Maine", "Vermont"]},
        "American": {0: ["FAU", "Temple"], 1: ["North-Texas", "UTSA"], 2: ["North-Texas", "UTSA"]},
        ...
        "Big West": {0: ["Cal-State-Fullerton", "UC-Riverside"], 0: ["Hawaii", "UC-Davis"]},
        "Coastal Athletic": {0: ["UNCW"], 1: ["William-Mary", "Monmouth", "Hofstra", "Elon"]},
        "Conference USA": {0: ["Delaware", "Jacksonville-State"], 1: ["Louisiana-Tech", "FIU", "Liberty", "Missouri-State"]},
        ...
        "MEAC": {0: ["Howard", "Maryland-Eastern-Shore", "Coppin-State", "Norfolk-State"]},
        "Mid-American": {0: ["Miami-OH", "Ohio", "Ball-State", "Toledo"]},
        "Missouri Valley": {0: ["Indiana-State", "Evansville", "Drake"]},
        ...
        "SWAC": {0: ["Bethune-Cookman", "Mississippi-Valley-State"], 1: ["Florida-AM", "Arkansas-Pine-Bluff"], 2: ["Alabama-AM", "Arkansas-Pine-Bluff", "Southern", "Alabama-State"]},
        ...
        "Western Athletic": {0: ["UTA"], 1: ["Tarleton-State", "UTA"]}
}
